...
\end{itemize}
\item Los atributos \texttt{rows} y \texttt{columns} de \texttt{MosaicPanel} no se accederán directamente. Se utilizarán métodos \texttt{set} y \texttt{get} para ello, incluso dentro e la propia clase.
...
\begin{enumerate}
\item Se creará un repositorio en Codeberg
\begin{itemize}
\item Será un \emph{fork} de \url{https://codeberg.org/alvarogonzalezsotillo/pentominos}
\end{itemize}
