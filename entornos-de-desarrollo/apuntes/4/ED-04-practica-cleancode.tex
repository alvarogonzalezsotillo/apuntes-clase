...
\begin{itemize}
\item Pero los métodos accessores (\texttt{getXXX, setXXX}) no cambian de nombre
\end{itemize}
...
\begin{itemize}
\item Consigue que la clase MakeIcons no tenga ningún aviso de Sonarqube, solucionando los problemas que indica.
\item Puedes \href{https://stackoverflow.com/questions/10971968/turning-sonar-off-for-certain-code}{ignorar el aviso} \texttt{S106} con un comentario en vez de solucionarlo
\end{itemize}
\subsection{Javadoc (1 punto)}
\label{sec:org000000c}
\begin{itemize}
\item Genera la documentación \emph{javadoc} del proyecto, de forma que sean visibles los cambios introducidos en esta práctica.
\item Se mostrarán también los métodos privados.
