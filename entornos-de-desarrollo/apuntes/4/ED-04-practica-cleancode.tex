...
\textattachfile{/home/alvaro/apuntes-clase/entornos-de-desarrollo/apuntes/4/ED-04-practica-cleancode.org}{} \vspace{-1em}
...
\begin{itemize}
\item Las normas de codificación de nuestra metodología indican que los atributos de las clases comienzan con el prefijo \texttt{m\_}, pero se mantienen los métodos \texttt{getXX} y \texttt{setXX}. Todos los atributos de la clase \texttt{MosaicPanel} se modificarán.
...
\item Puedes ignorar el aviso \texttt{S106}
\end{itemize}
