...
* Sonarqube
La instalación es complicada, la simplificaremos con Podman
[[https://medium.com/@akashlomas/code-evaluation-with-sonar-qube-sonar-scanner-on-podman-4e647866ea6b][Fuente]] 
...
** Cliente Sonarqube
Tras crear el proyecto en el servidor, y conseguir el /token/
