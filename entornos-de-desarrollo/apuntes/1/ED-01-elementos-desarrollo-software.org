...
- *Código ejecutable*: archivo binario ejecutable.
  - En lenguajes interpretados no exite código objeto, ni ejecutable. Solo código fuente. Por ejemplo: PHP, Javascript, ...
  - Aunque podría existir en memoria ([[https://en.wikipedia.org/wiki/Just-in-time_compilation][JIT compiler]])  

#+reveal: split

#+caption: Código ensamblador, equivalente a código ejecutable
#+begin_src asm
