...
\item Grupal (50\%)
\begin{itemize}
\item (30\%) \textbf{Contenido}: El material preparado permite entender la herramienta elegida. Bien resumido, ordenado, claro, con los diagramas necesarios para ser entendido.
