...
\end{itemize}
\item El método \texttt{solapamiento} contiene errores, será necesario corregirlos. No se permite usar funciones ni variables adicionales en este método, ni cambiar la estructura: hay que corregir la lógica (25\%)
\end{itemize}
