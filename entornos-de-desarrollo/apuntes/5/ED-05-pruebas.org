...
- Ejercicios:
  ...
  - Función que valida un número de teléfono que puede ser [[https://www.consumoresponde.es/art%C3%ADculos/tipologia_de_los_numeros_de_telefono_existentes_en_espana][local a España]] o [[https://www.itu.int/dms_pub/itu-t/opb/sp/T-SP-E.164C-2011-PDF-S.pdf#page=3][internacional]]
...
- Las clases de JUnit están en [[https://github.com/junit-team/junit4/wiki/Download-and-Install][su fichero jar]]. También necesita el jar de [[https://github.com/hamcrest/JavaHamcrest][Hamcrest]].
  ...
  - La versión [[https://docs.junit.org/6.0.3/appendix.html#dependency-metadata-dependencies][6 es bastante más complicada]] (para este curso, no compensa)  
...
| @BeforeClass | Se aplica a un método static para indicar que se ejecuta antes que todos los métodos de prueba de la clase. |
| @AfterClass  | Se aplica a un método static para indicar que se ejecuta después de todos los métodos de prueba de la clase. |
| @Ignore      | Se aplica a un método de prueba para evitar esa prueba                                                    |
...
** Ejercicio: emails
- Comprender [[https://en.wikipedia.org/wiki/Email_address#Syntax][qué es una dirección de email]]
...
#+end_src
- Devuelve los pares de puntos más cercanos ([[https://es.wikipedia.org/wiki/Distancia_euclidiana][distancia euclídea]])
...
- Por ejemplo =(1,20) (18,1) (2,110) (3,3) (51,8) (100,0) (100,1) (4,5)= devolvería un array de longitud 1. Cada posición es un array de dos puntos
  - =(3,3) (4,5)=
- Pista: [[https://docs.google.com/spreadsheets/d/1m3LLt14JVIlu2p_0rq_d0kpMjnnxs6q1Yb3m9rz0-hg/edit?usp=sharing][dibuja los puntos de los ejemplos]] para entenderlo    
- Qué hacer:
  - Definir casos de prueba: AVL, clases de equivalencia, conjetura de errores...
  - Implementar los casos de prueba
  - Implementar el método        

** Ejercicio: [[https://es.wikipedia.org/wiki/Matr%C3%ADculas_automovil%C3%ADsticas_de_Espa%C3%B1a#Sistema_nacional][matrículas]]
#+begin_src java
/**
