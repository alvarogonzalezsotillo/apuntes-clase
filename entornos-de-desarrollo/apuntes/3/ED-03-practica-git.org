...
3. Un alumno del grupo hace un [[https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/fork-a-repo][/fork/]] del repositorio https://codeberg.org/alvarogonzalezsotillo/Java-Games.git
4. El repositorio debe ser privado.
   - Da permisos completos al profesor alvaro.gonzalezsotillo@educa.madrid.org.
   - Da permisos completos a tu(s) compañero(s) de práctica.
...
- Se comprobará mediante la historia del repositorio, el nombre y correo de los /commits/ y el comando [[https://git-scm.com/docs/git-blame][=git blame=]]  
