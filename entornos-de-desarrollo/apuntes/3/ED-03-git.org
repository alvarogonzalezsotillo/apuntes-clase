...
#+reveal: split
[[file:media/meme-control-versiones.png]]
...
- Por convenio, suele haber un repositorio "/central/"
  ...
  - Autoalojado: [[https://about.gitea.com/products/gitea/][gitea]], [[https://forgejo.org/][forgejo]]
...
** =clone= <<#clone>>
  ...
  - La copia de trabajo será la de la rama por defecto (=main= o =master=)
...
* Codeberg en /selfhosting/: Forgejo
- Esta es una instalación no apta para producción, solo para pruebas
  - Basada en [[https://podman.io/][Podman]]
  - Con la [[https://codeberg.org/forgejo/-/packages/container/forgejo/versions][imagen oficial]]
