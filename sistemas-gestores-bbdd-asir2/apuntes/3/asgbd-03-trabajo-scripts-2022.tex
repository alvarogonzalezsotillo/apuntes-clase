...
\textattachfile{/home/alvaro/apuntes-clase-profesor/sistemas-gestores-bbdd-asir2/apuntes/3/asgbd-03-trabajo-scripts-2022.org}{} \vspace{-1em}
...
\begin{itemize}
\item La contraseña será el nombre de usuario
\end{itemize}
\item Si el usuario ya existe, no se hará nada con él
\end{itemize}

\begin{lstlisting}[language=bash,label=lst:nuevos-usuarios-ejemplo,caption={Ejemplo de uso},captionpos=b,numbers=none]
...
\begin{lstlisting}[language=bash,label=lst:quita-usuario-ayuda,caption={Ayuda del script \texttt{quita-usuario-oracle.sh}},captionpos=b,numbers=none]
...
\begin{lstlisting}[language=SQL,label=lst:tabla.sql,caption={Creación de la tabla \texttt{ESTADO}},captionpos=b,numbers=none]
  create table ESTADO(
    uptime varchar(40),
    procesos varchar(40),
    disco varchar(40),
