...
La última versión de este documento se puede descargar de [[https://alvarogonzalezsotillo.github.io/apuntes-clase/sistemas-gestores-bbdd-asir2/apuntes/3/asgbd-03-trabajo-scripts-2026.release.pdf]]
...
Crea dos /scripts/ para iniciar y parar *Oracle*. Deben controlar el /listener/, la instancia y las /pluggable database/
  - =/home/alumno/scripts/oraclestart.sh=: Si la instancia está parada, la arranca. Si no, dice que ya está arrancada.
  - =/home/alumno/scripts/oraclestop.sh=: Si la instanacia está arrancada, la para. Si no, dice que ya está parada.
...
* Envía un correo periódicamente (3 puntos)
