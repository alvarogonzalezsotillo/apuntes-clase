...
\begin{homeworkProblem}[: Apaga o enciende Oracle (3 puntos)]
  ...
  \item Si no se está ejecutando, preguntará si se desea arrancar la instancia. Si se responde \texttt{si}, se arrancará el listener y la instancia.
  \end{itemize}
...
Este ejercicio es para la autoevaluación. Consulta al profesor mediante la mensajería del aula virtual o en las tutorías presenciales de FFE si tienes dudas.
