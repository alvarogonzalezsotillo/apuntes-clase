...
Usando el usuario =OPERARIOBACKUP=, realiza un /backup/ de las tablas =JUGADORES=, =MATRICULAS= y =EQUIPOS=. Incluye en la memoria los comandos utilizados, el fichero de /log/ el fichero de backup generado.  
