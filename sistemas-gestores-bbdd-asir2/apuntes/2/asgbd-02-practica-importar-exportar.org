...
* Incorpora otro /backup/
- Usando el usuario =OPERARIOBACKUP=, importa el fichero [[https://alvarogonzalezsotillo.gihub.io/apuntes-clase/sistemas-gestores-bbdd-asir2/apuntes/2/multas-practica.dump][=multas-practica.dump=]] en el tu usuario.
- Incluye en la memoria los comandos exactos utilizados.
...
- El archivo de /backup/ de las tablas =JUGADORES= y =EQUIPOS=, y los archivos de /log/ generado en el prodceso
