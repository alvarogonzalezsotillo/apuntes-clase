...
* (3 puntos)/Backup/ de algunas tablas
Realiza un /backup/ de las tablas =JUGADORES=, =MATRICULAS= y =EQUIPOS=. Incluye en la memoria los comandos utilizados y el fichero de backup generado.  
...
- El archivo de /backup/ de las tablas =JUGADORES=, =MATRICULAS= y =EQUIPOS=, y los archivos de /log/ generado en el prodceso
