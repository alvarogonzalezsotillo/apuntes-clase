...
** Conectar sin contraseña como =SYS= a PDB en local
- Se usa la variable =ORACLE_PDB_SID=, junto con =ORACLE_SID=
- También no funciona con =sqlplus=  
#+begin_src bash
...
** Conectar sin contraseña en /connection string/
...
#+begin_src bash
expdp \'sys@PDB_PDASIR as sysdba\' DIRECTORY=datos DUMPFILE=\'con espacios.dmp\'
#+end_src


*** bibliografía                                                  :noexport:
