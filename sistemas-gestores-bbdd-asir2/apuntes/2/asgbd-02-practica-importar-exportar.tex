...
\item El archivo de \emph{backup} de las tablas \texttt{JUGADORES}, \texttt{MULTAS} y \texttt{EQUIPOS}, y los archivos de \emph{log} generado en el prodceso
\end{itemize}
