...
Usando el usuario \texttt{OPERARIOBACKUP}, realiza un \emph{backup} de las tablas \texttt{JUGADORES}, \texttt{MATRICULAS} y \texttt{EQUIPOS}. Incluye en la memoria los comandos utilizados, el fichero de \emph{log} el fichero de backup generado.  
