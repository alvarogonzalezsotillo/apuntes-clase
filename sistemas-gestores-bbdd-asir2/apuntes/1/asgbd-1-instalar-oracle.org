...
- Pero también puede instalarse por separado:
  ...
  - https://download.oracle.com/otn_software/linux/instantclient/2120000/instantclient-sqlplus-linux.x64-21.20.0.0.0dbru.zip
  - https://download.oracle.com/otn_software/linux/instantclient/2120000/instantclient-tools-linux.x64-21.20.0.0.0dbru.zip
- Tras descomprimir, hay que definir la variable =LD_LIBRARY_PATH= al directorio de instalación
  - Otros años ha echo falta también =ORACLE_HOME=
- Puede ser necesaria la libería =libaio= o =libnsl=
