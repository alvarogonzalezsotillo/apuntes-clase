...
- Docker integra diversas capacidades de aislamiento entre procesos que tiene Linux
  - [[https://en.wikipedia.org/wiki/Chroot][chroot]] ([[file:chroot.sh][ejemplo]])
...
- Conclusión
  - [[https://akashrajpurohit.com/blog/build-your-own-docker-with-linux-namespaces-cgroups-and-chroot-handson-guide/][Se pueden crear containers sin usar Docker]] ([[https://github.com/p8952/bocker][Bocker]])
  - Pero Docker es más cómodo  
...
- ¿Hay Docker para Windows?
  - Respuesta corta: No (el /daemon/ Docker solo funciona en Linux)
  - Respuesta larga:
    - Hay /Docker Desktop/ para Windows, que usa [[https://learn.microsoft.com/en-us/windows/wsl/compare-versions][WSL2]] (básicamente, una máquina virtual)
    - El cliente Docker se conecta al servidor Docker dentro de WSL2
...
- Pueden ser
  ...
  #+end_src
  - =-dit= : *d* etached, *i* nteractive, *t* ty
...
* Práctica: instalar con =docker compose=
- [[https://docs.docker.com/compose/][=docker compose=]] es una extensión para definir varios /containers/ en un fichero [[https://en.wikipedia.org/wiki/YAML][=yaml=]]
...
#+begin_src yaml
name: "Oracle con docker compose"
services:
    enterprise:
        ...
        ports:
            ...
            - 5500:5500
        environment:
            - ORACLE_SID=SID_COMPOSE
            - ORACLE_PDB=PDB_COMPOSE
            - ORACLE_PWD=changemesecret
