...
- Usaremos la imagen =container-registry.oracle.com/database/enterprise:21.3.0.0=
  - El /registry/ de oracle requiere usuario y contraseña
    - Usuario: el de la cuenta de Oracle
    - Contraseña: el /auth token/ de la página https://container-registry.oracle.com 
- Se recomienda usar el /registry/ del instituto
...
** En nuestro caso
- Solo el puerto =1521=
- Ficheros en =/opt/oracle/oradata=
- Nombre del container =oracle-enterprise-21.3.0.0=
- Haz un /script/ en la máquina real para ejecutar =sqlplus= como =SYSDBA=
  - con =docker exec=
