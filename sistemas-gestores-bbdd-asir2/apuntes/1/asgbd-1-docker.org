...
- ¿Hay Docker para Windows?
  ...
  - Respuesta larga:
    ...
    - También hay [[https://learn.microsoft.com/en-us/virtualization/windowscontainers/about/][/containers/ para Windows]], solo instalables en Windows  
...
* Práctica: instalar Oracle :noexport:
