...
- Ser algo: Exhibir algún rasgo o característica física intransferible: Biometría.
  - Huellas digitales, vasos sanguíneos, iris, rostro, voz, dna, retina
  - Movimientos característicos: labios, firma tradicional, forma de teclear, análisis de marcha  
...
* Sujeción y factores de forma en entorno profesional: el Rack :noexport:
...
** Conectores y entradas normalizados (IEC) :noexport:
...
Siendo:
- $P_{watios}$: Potencias expresadas en Watts (Vatios)
...
** Regletas protectoras de sobretensiones. :noexport:
...
- Si expresan la corriente que consumen en Amperios, multiplica por 230 (la tensión efectiva AC). El resultado serán los Voltio-Amperios que deberá tener el SAI. Ej.: Para un equipo que necesite 3A, se necesita un SAI de al menos 690VA (Sacado de multiplicar 3×230).

Resumiendo:

$$P_{voltioamperio} = V_{ef} \times I_{ef}$$

$$P_{voltioamperio} = \frac{P_{watios}}{0.7}$$

El factor $0.7$ es debido al desfase entre la subida de tensión y la subida de intensidad. Cuanto menos desfase haya, más se parecerá a $1$, y más caro será el SAI.
