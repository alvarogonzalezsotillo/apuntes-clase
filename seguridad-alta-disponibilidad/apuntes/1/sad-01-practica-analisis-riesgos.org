...
- Realiza un análisis de riesgos de este caso, siguiendo el esquema que conoces del análisis.
- Plásmalo en un documento hecho con tu procesador de textos favorito. Puedes utilizar la plantilla adjunta en el taller.
