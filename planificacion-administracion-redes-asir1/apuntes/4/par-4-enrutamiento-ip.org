...
* /Router on a stick/
- Un /router/ puede tener dos direcciones en una interfaz
- En ese caso, puede enrutar los paquetes que le llegan por una interfaz por esa misma interfaz
  - Ejemplo: la figura tiene un router con solo una interfaz entre las redes 192.168.1.0/24 y 192.168.40.0/24
...
- Añadir una ruta para la red 157.0.0.0/8: se va por la interfaz =eth0=, con métrica 3. Se envía al router 157.55.80.1
#+begin_src sh
sudo ip route add 157.0.0.0/8 via 157.55.80.1 dev eth0 metric 3
#+end_src
- La métrica y la interfaz son opcionales
