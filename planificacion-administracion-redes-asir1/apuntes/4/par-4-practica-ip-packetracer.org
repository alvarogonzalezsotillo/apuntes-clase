...
El número =n= de la red se corresponde con el asignado al alumno en la columna *Número práctica PT* de https://docs.google.com/spreadsheets/d/1z1B07ee3VjmYwtd1i0wCBRPnjZS00oExbGXNDlNa93E/edit?gid=0#gid=0
...
- Cada planta tendrá un /router/, su /switch/ (sistema horizontal), el primer puesto de trabajo y el último puesto de trabajo.
- Los routers de las plantas se unirán por un /switch/ (sistema vertical).
