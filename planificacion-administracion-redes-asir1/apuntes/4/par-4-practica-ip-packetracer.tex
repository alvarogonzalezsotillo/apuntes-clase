...
\begin{itemize}
\item entre todos los \textit{hosts} de una planta
\item entre todos los \textit{routers}, usando la red de \textit{routers}
\item entre todos los \textit{hosts} y todos los \textit{routers}
\end{itemize}
\item No se considera un error que no se pueda hacer \texttt{ping} entre \textit{hosts} de plantas distintas
\end{itemize}
