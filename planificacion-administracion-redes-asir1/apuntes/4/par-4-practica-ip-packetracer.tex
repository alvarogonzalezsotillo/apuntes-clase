...
\textattachfile{/home/alvaro/apuntes-clase/planificacion-administracion-redes-asir1/apuntes/4/par-4-practica-ip-packetracer.org}{} \vspace{-1em}
...
\item Los routers de las plantas se unirán por un \emph{switch} (sistema vertical).
\item Habrá comunicación a nivel IP (\texttt{ping})
\begin{itemize}
\item entre todos los \emph{hosts} de una planta
\item entre todos los \emph{routers}, usando la red de \emph{routers}
\end{itemize}
