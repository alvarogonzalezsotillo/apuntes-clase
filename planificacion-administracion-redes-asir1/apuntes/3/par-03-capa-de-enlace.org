...
- En la actualidad se utiliza [[https://en.wikipedia.org/wiki/Reed%E2%80%93Solomon_error_correction][Reed-Solomon]]
  - CD, DVD, BlueRay
  - QR ([[https://nythrox.github.io/halftone-qrcode/][generador]])
  - Raid 6
  - DVB, WiMax, transmisiones aeroespaciales    
 
* Ejemplo: [[https://en.wikipedia.org/wiki/RS-232][RS232]]
- Conocido como [[https://es.wikipedia.org/wiki/Puerto_serie][/puerto serie/]]
- Utiliza codificación de canal [[https://es.wikipedia.org/wiki/C%C3%B3digos_NRZ][NRZ]]
- Siempre hay un bit de inicio de palabra, a nivel alto  
- Parámetros:
  - baudios
  - bits de datos: generalmente 8
  - bit de paridad: sin paridad, paridad par o paridad impar
  - bits de parada: 1 o 2, nivel bajo

[[file:media/Puerto_serie_Rs232.png]]

#+reveal: split
[[file:media/configuracion-puerto-serie-putty.png]]

Ejemplo: [[https://xdaforums.com/t/howto-linux-on-xiaomi-mi-box-s-mdz-22-ab.3884685/][/rootear/ dispositos]]
* Referencias
