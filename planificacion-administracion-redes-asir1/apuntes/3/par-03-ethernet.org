...
- Utilizan cable UTP de cat. 5e o 6.
  - [[https://es.wikipedia.org/wiki/100Base-TX][100 Base TX]]
    - Usa codificación 4B/5B [[https://en.wikipedia.org/wiki/MLT-3_encoding][MLT-3]]
  - 1000 Base T
...
Nota: [[https://www.iana.org/assignments/ieee-802-numbers/ieee-802-numbers.xhtml][Lista de /ethertypes/ de la IANA]] y [[https://standards-oui.ieee.org/ethertype/eth.txt][lista de IEEE]]
