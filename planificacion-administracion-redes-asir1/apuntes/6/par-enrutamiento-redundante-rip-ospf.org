...
- IP decide qué ruta aplicar de la siguiente forma
  ...
  - En implementaciones reales, se miran otros criterios antes de la métrica:
    - /Flags/ de la ruta
...
#+begin_export latex
\attachfile[mimetype=octet/stream,
author={./pkt/redundancia-routers-rip.pkt},
subject={La plantilla},
appearance=false,
icon=Paperclip,
description={La plantilla}]
{./pkt/redundancia-routers-rip.pkt}
#+end_export
...
** Interfaces pasivas
- La información de RIP se envía por todas las interfaces que se anuncian
- Si no hay routers por una red anunciada, estos mensajes no tienen sentido
  - Sobrecarga el enlace
  - Sobrecarga los equipos en el enlace
  - Seguridad: menor confidencialidad, y posibilidad de interferencia
- Una interfaz pasiva se anuncia por otras interfaces, pero no se envían anuncios por ellas, ni se atiende a los anuncios que lleguen por ellas
