...
\textattachfile{/home/alvaro/apuntes-clase/planificacion-administracion-redes-asir1/apuntes/6/par-6-ejercicios-nat-de-cisco-netacad.org}{} \vspace{-1em}
...
\item Se enviará también un pantallazo de la ventana de "\emph{Assesment items}", con el árbol visible
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{media/ventana-assessment-items.jpg}
\caption{Ejemplo de ventana a enviar (esta es de otro PKA)}
\end{figure}
\begin{itemize}
