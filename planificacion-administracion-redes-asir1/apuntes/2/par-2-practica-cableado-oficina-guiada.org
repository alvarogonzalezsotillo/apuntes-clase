...
- En la sala de lectura se instalarán 4 puntos de acceso en cada una de las 6 columnas.
- Inicialmente, solo se espera utilizar un punto de red por cada uno de los despachos de la biblioteca, y un punto de red por colummna.
