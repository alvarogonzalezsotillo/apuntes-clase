...
Existen muchas organizaciones internacionales y nacionales, organizaciones de regulación gubernamentales y empresas privadas que intervienen en el establecimiento y el mantenimiento de los estándares de la capa física. Por ejemplo, los estándares de hardware, medios, codificación y señalización de la capa física están definidos y regidos por estas organizaciones de estándares:
    ...
    \item Organización Internacional para la Estandarización (ISO)
    \item     Asociación de las Industrias de las Telecomunicaciones (TIA) y Asociación de Industrias Electrónicas (EIA)
    \item     Unión Internacional de Telecomunicaciones (ITU)
    \item     Instituto Nacional Estadounidense de Estándares (ANSI)
    \item     Instituto de Ingenieros Eléctricos y Electrónicos (IEEE)
    \item     Autoridades nacionales reguladoras de las telecomunicaciones, incluida la Federal Communication Commission (FCC) de los Estados Unidos y el Instituto Europeo de Estándares de Telecomunicaciones (ETSI)
...
- Determina los baudios y bits por segundo de:
  ...
  - Una sinusoidal, que 10 veces por segundo puede
    - cambiar a tres frecuencias posibles
...
** Código [[https://es.wikipedia.org/wiki/Códigos_NRZ][NRZ-L]] (bipolar)
| 0 | -xV |
| 1 | +xV |
...
(comprobar en https://alvarogonzalezsotillo.github.io/fft/)
