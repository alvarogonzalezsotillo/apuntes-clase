...
*** Cable PoE
- /[[https://es.wikipedia.org/wiki/Power_over_Ethernet][Power over Ethernet]]/
...
- Se /cruzan/ ellos mismos si es necesario: [[https://en.wikipedia.org/wiki/Medium-dependent_interface#Automatic_MDI-X][MDI-X automático]]
- Hay algunas excepciones, como [[https://www.cisco.com/c/en/us/td/docs/switches/lan/catalyst9300/software/release/16-10/configuration_guide/int_hw/b_1610_int_and_hw_9300_cg/configuring_auto_mdix.pdf][Cisco]]


*** Construcción de cables
- Conector (macho): [[https://www.youtube.com/watch?v=NWhoJp8UQpo]]
...
Nota: [[https://htwins.net/scale2/][tamaños de ondas]]
#+reveal: split
...
- En cada instante se hay presencia o ausencia de señal luminosa.
  - Se pueden usar diferentes colores para una multiplexación por frecuencia
