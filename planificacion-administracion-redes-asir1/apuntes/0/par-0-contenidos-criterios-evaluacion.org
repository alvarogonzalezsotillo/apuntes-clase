...
- Packet tracer VS Linux & Windows
  ...
  - Versión 8.2.2 (aunque cambie durante el curso, usaremos esta)
- Curso NETACAD:
...
- Nivel de red (TCP/IP)
  ...
  - La subdivisión de redes y el uso de máscaras de longitud variable VLSM (Variable Length Subnet Mask).
  - Superredes y CIDR (Classless Inter-Domain Routing).
  - Fragmentación IP.
...
- Redes de área local inalámbricas (IEEE 802.11)
  ...
  - Topologías. Arquitectura celular BSS (Basic Service Set). Ad-hoc (Peer-to-Peer). Modo infraestructura. SSID. Canales. Interconexión de BSSs ESS (Extended Service).
...
g) /Se han utilizado diferentes tecnologías de túnel para interconectar redes a través de Internet/


* Distribución de RA en unidades de trabajo

| Peso en la calificación final de cada RA |   5.00% |   5.00% | 10.00% | 20.00% |  15.00% |  40.00% |   5.00% |
|------------------------------------------+---------+---------+--------+--------+---------+---------+---------|
|                                          |     RA1 |     RA2 |    RA3 |    RA4 |     RA5 |     RA6 |     RA7 |
|------------------------------------------+---------+---------+--------+--------+---------+---------+---------|
| UT1 Estructura de redes de datos         | 100.00% |         |        |        |         |         |         |
| UT2 Conexión básica de ordenadores       |         | 100.00% |        |        |         |         |         |
| UT3 Switches                             |         |         | 40.00% |        |         |         |         |
| UT4 Enrutamiento                         |         |         |        | 50.00% |         |         |         |
| UT5 VLAN                                 |         |         | 60.00% |        | 100.00% |         |         |
| UT6 Administración de routers            |         |         |        | 50.00% |         | 100.00% |         |
| UT7 Interconexión con redes públicas     |         |         |        |        |         |         | 100.00% |
