...
\begin{homeworkProblem}[: \imenu{Simulación de cliente web (2 puntos)}]
  ...
  \item Si no se consigue ninguna respuesta, puede ser que se corte la conexión antes de recibirla. Prueba con \texttt{-d 1} para añadir un retardo en cada línea enviada.
  \end{itemize}
