...
* Tramas de /broadcast/
  ...
  - Haz una lista de las pilas de protocolos (desde nivel de enlace hasta el nivel más alto) que viajan sobre tramas de /broadcast/, e incluye al menos 3 pantallazos de estas pilas como ejemplo.
  - ¿Para qué se utilizan esos protocolos encontrados de nivel superior?
...
* Encuentra protocolos de nivel de enlace
