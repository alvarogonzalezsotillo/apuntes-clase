...
\textattachfile{/datos-luks/datos-alvaro/apuntes-clase/planificacion-administracion-redes-asir1/apuntes/1/par-1-trabajo-wireshark-ii.org}{} \vspace{-1em}
...
\item Haz una lista de las pilas de protocolos (desde nivel de enlace hasta el nivel más alto) que viajan sobre tramas de \emph{broadcast}, e incluye al menos 3 pantallazos de estas pilas como ejemplo.
\item ¿Para qué se utilizan esos protocolos encontrados de nivel superior?
\end{itemize}
...
\end{Aviso}
\end{adjustwidth}
\section{Encuentra protocolos de nivel de enlace}
\label{sec:org0000006}
En la red hay al menos dos protocolos que son de nivel de enlace, con funciones muy similares entre ellos.

Encuéntralos y pon aquí al menos dos pilas de protocolos que usen esos niveles de enlace
