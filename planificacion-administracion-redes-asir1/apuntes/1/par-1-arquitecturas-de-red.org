...
- Pronto se vio que la arquitectura /monolítica/ no era funcional y se pasó al modelo /por capas/ o niveles.
...
- Utiliza frecuencias que no se utilizan en la comunicación vocal
  - ADSL (Asymmetric): el canal de bajada es mayor que el canal de subida
