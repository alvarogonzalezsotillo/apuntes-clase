...
- Redes públicas
  - Compañías telefónicas y de acceso a Internet (/ISP Internet Service Provider/)
...
#+reveal: split
- Clasifica estas redes según su propietario
  - /GPRS/
  - /X25/
  - Wi-fi
  - /IrDA/
...
- Redes cableadas (medios guiados)
  ...
  - Óptico
    - Fibra óptica
- Redes inalámbricas (radiofrecuencia)
