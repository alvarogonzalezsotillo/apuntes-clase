...
\section{Comprueba que tu ISP te proporciona una IP pública}
Muchos operadores, sobre todo de bajo coste, ofrecen acceso a internet a través de \enlace{https://en.wikipedia.org/wiki/Carrier-grade_NAT}{CGNAT}. Comprueba si tu operador tiene la \enlace{https://roams.es/companias-telefonicas/blog/internet/cgnat/}{posibilidad de salir del CGNAT}, generalmente llamando a atención al cliente.
