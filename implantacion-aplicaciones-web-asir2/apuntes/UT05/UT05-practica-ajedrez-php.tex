...
\item El alumno debe ser capaz de explicar cada línea de PHP entregada. En otro caso, se considerará una práctica copiada
\end{itemize}
...
\end{itemize}
\end{itemize}
\section{Para llegar al 10\ldots{} (1 punto)}
\label{sec:org000000c}
Modifica \texttt{tablerocompartido.php} y \texttt{mitablero.php} para que cuando se pinche en un escaque, el \texttt{<input>} que se utiliza para determinar la posición de la pieza se actualice al escaque pinchado.
\begin{itemize}
\item Utiliza \href{https://www.geeksforgeeks.org/javascript/javascript-onclick-event/}{\texttt{onclick}} en el escaque
\item Asegúrate que el \texttt{<input>} tiene un \texttt{id}
\item Y usa \texttt{document.getElementById(...).value=....}
\end{itemize}
