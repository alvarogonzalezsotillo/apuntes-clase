...
- Habrá un formulario con fila, columna y valor de tesela. Cuando se envíe, se cambiará en la base de datos y se recargará la página. (50%)
  - Cuando se pinche en la mazmorra, se cambiará con /javascript/ el valor de la fila y columna (20%)
  - Cuando se pinche en la paleta, se cambiará con /javascript/ el valor de la tesela (20%)
- Extra: realizar solo una consulta de base de datos (10%)
...
Crea una página PHP de nombre =restaurar-sesion.php=
