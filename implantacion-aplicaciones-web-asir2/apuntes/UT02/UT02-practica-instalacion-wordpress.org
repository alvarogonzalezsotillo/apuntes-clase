...
- Una noticia será cómo se ha instalado el Wordpress: pasos seguidos, pantallazos, herramientas (ssh, ftp...)
...
- El menú estará en todas las páginas  
- Una página de /Quiénes somos/
- Una página con las últimas noticias. Esta página muestra las noticias según se van creando.
