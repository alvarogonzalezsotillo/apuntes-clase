...
** Ventajas
- Sobre un desarrollo propio o un sitio con HTML/CSS
  - Facilidad de uso
  - Niveles de acceso  
...
- En algún fichero, información sobre como conectar a MySQL
  - Usuario, contraseña, /database/, dirección IP, puerto
...
- Instala Moodle en tu /workspace de Coder/
  ...
  - Datos adicionales en un subdirectorio de =/extradata= (no se borra)  
  - Usa HTTPS
