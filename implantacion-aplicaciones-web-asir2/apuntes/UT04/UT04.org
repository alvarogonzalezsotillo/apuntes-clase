...
- Crea una página PHP que almacene una /cookie/ en el navegador
  ...
  - Valor: La hora de la petición de la página (ver [[https://www.php.net/manual/en/function.getdate.php][=getdate()=]])
- La página, si recibe la /cookie/, mostrará la hora del acceso anterior, y la hora actual      
