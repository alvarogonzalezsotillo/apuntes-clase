...
- Para la operación módulo:
  - Los operandos se aproximarán a enteros
  - En vez de mostrar los operandos originales, se mostrarán los aproximados a entero.  
...
- Para probar los dos primeros ejercicios, el profesor incluirá un fichero como el siguiente, y lo ejecutará en Apache del alumno
