...
\section{Mazmorra tipo \emph{Mario Bros}}
...
\item Si es la primera vez que se ejecuta, aparecerán los valores vacíos, y \texttt{+} seleccionado.
\item Para la operación módulo:
\begin{itemize}
\item Los operandos se aproximarán a enteros
\item En vez de mostrar los operandos originales, se mostrarán los aproximados a entero.
\end{itemize}
\end{itemize}
...
\end{itemize}
\item Para probar los dos primeros ejercicios, el profesor incluirá un fichero como el siguiente, y lo ejecutará en Apache del alumno
\end{itemize}
